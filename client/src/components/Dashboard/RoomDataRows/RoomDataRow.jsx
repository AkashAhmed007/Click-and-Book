 ...
 const [isEditModal,setIsEditModal] = useState(false)
  ...
  return (
    <tr>
      ...
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        <button onClick={()=>setIsEditModal(true)}className='relative cursor-pointer inline-block px-3 py-1 font-semibold text-green-900 leading-tight'>
          <span
            aria-hidden='true'
        ...
        <UpdateRoomModal isOpen={isEditModal} setIsEditModal={setIsEditModal} room={room} refetch={refetch} ></UpdateRoomModal>
      </td>
    </tr>
  )
}
